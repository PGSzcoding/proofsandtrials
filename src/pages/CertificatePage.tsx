    ...
    <main className=" pt-20">
      <Container className="min-h-[calc(100vh-260px)] flex items-center">
        ...
        <div className="grid w-full items-center gap-12 lg:grid-cols-2">
          ...
          {/* Image */}
          <div className="relative hidden h-[560px] overflow-hidden rounded-3xl bg-slate-100 shadow-xl lg:block">
  <img
    src={certificateImage}
    alt="Consulta de certificados P&T"
    ...
    <p className=" text-sm leading-6 text-white/80">
      Certificados confiables
          ...
          <div>
            ...
            <h1 className="mt-4 text-5xl font-bold leading-tight text-slate-800">
            ...
            <form className="mt-10 max-w-md">
              ...
              <input
                ...
                className="
                  w-full rounded-full border border-slate-300 
